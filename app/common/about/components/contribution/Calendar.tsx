  ...
  return (
    <>
      <div className="relative flex flex-col">
        <ul className="flex justify-end gap-5 overflow-hidden text-xs dark:text-neutral-400 md:justify-start">
          {months.map((month) => (
            <li
              key={month.firstDay}
              ...
              {week.contributionDays.map((contribution) => {
                ...
                return (
                  <motion.span
                    ...
                    className="my-[2px] block h-[16px] w-[16px] rounded-sm bg-neutral-300 dark:bg-neutral-800"
